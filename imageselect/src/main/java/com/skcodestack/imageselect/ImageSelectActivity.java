...
import com.skcodestack.imageselect.adapter.SelectImageListAdapter;
import com.skcodestack.imageselect.adapter.helper.CaptureImageHelper;
import com.skcodestack.imageselect.helper.OnItemSelectedChangedListener;
import com.skcodestack.imageselect.itemdecoration.GridLayoutItemDecoration;
...
public class ImageSelectActivity extends AppCompatActivity implements OnItemSelectedChangedListener<String>, View.OnClickListener, SelectImageListAdapter.OnCaptureImageListener {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_query) {
            ...
            if (mResultList != null && mResultList.size() > 0) {
                ImagePerviewActivity.start(mActivity, mResultList, 0);
            }
        }
    }
    ...
    private void startCamera() {
        ...
        mTemFile = imagefile;
        CaptureImageHelper.setAuthority("com.skcodestack.imageselect");
