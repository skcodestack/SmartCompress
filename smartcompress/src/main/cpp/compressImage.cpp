 ...
 * com.skcodestack.scompress.util;
 * Method:    compressBitmap
 * Signature: (Ljava/lang/Object;ILjava/lang/String;B)I
 */

extern "C"
JNIEXPORT jint JNICALL Java_com_skcodestack_scompress_util_CompressUtil_compressBitmap
        (JNIEnv *env, jclass clazz, jobject bitmap, jint quality, jstring dstFile,
         jboolean optimize) {
